...
export default function FooterTop() {
    return (
        <section className="footer-top container flex fd-column ai-center" >
            <p className="title fw-bold" >We are ready for your project.</p>
            <p className="subtitle fw-bold" >If you are too.</p>
            <Link href="/contact"  >
                <a className="flex ai-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16.749" height="12.758" viewBox="0 0 16.749 12.758">
